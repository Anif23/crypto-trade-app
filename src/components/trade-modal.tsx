...
export function TradeModal({
  ...
  return (
    <>
      <Dialog open={open && !confirmOpen} onOpenChange={(v) => { setConfirmOpen(false); onOpenChange(v); }}>
        <DialogContent onClose={closeAll}>
          <DialogHeader>
      ...
      <Dialog open={confirmOpen} onOpenChange={(v) => { setConfirmOpen(v); if (!v) onOpenChange(false); }}>
        <DialogContent onClose={() => { setConfirmOpen(false); onOpenChange(false); }}>
          <DialogHeader>
